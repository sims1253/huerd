...
knitr::opts_chunk$set(
  ...
  fig.width = 12,  # Increased width for better readability
  fig.height = 8,  # Increased height for better readability
  dev = "png",
...
A discrete color palette generator with support for fixed colors, optimized for color vision deficient viewers.
