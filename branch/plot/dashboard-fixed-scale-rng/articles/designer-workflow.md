...
1.  **[`brand_palette()`](https://sims1253.github.io/huerd/branch/plot/dashboard-fixed-scale-rng/reference/brand_palette.md)** -
    Start with your required brand colors
2.  **`quick_palette(lightness = ...)`** - Control lightness for
    print/digital
3.  **[`interpret_palette_quality()`](https://sims1253.github.io/huerd/branch/plot/dashboard-fixed-scale-rng/reference/interpret_palette_quality.md)** -
    Client-ready quality language
4.  **[`simulate_palette_cvd()`](https://sims1253.github.io/huerd/branch/plot/dashboard-fixed-scale-rng/reference/simulate_palette_cvd.md)** -
    Accessibility documentation
5.  **[`export_palette()`](https://sims1253.github.io/huerd/branch/plot/dashboard-fixed-scale-rng/reference/export_palette.md)** -
    CSS, Sass, JSON, CSV exports
6.  **[`reproduce_palette()`](https://sims1253.github.io/huerd/branch/plot/dashboard-fixed-scale-rng/reference/reproduce_palette.md)** -
