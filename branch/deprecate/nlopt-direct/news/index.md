...
- [`interpret_palette_quality()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/interpret_palette_quality.md)
...
- `validate_color_input_smart()` now reports the actual problem (“Colors
  ...
  message
- [`export_palette()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/export_palette.md)
...
- The previously ignored `cvd_safe` arguments of
  [`quick_palette()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/quick_palette.md)
  and
  [`brand_palette()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/brand_palette.md)
  are now forwarded to
  [`generate_palette()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/generate_palette.md)
  and take effect
- [`reproduce_palette()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/reproduce_palette.md)
...
- [`plot_palette_analysis()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/plot_palette_analysis.md)
  now returns `invisible(NULL)` without warning when fewer than two
  colors are supplied.
- [`simulate_palette_cvd()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/simulate_palette_cvd.md)
...
- Fixed hex color validation regex in
  [`evaluate_palette()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/evaluate_palette.md)
...
- Added
  [`plot.huerd_palette()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/plot.huerd_palette.md)
  method with “swatches” and “analysis” plot types
- Added ggplot2 integration:
  [`scale_color_huerd()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/scale_color_huerd.md),
  [`scale_fill_huerd()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/scale_color_huerd.md),
  [`scale_colour_huerd()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/scale_color_huerd.md)
...
- The
  [`is_cvd_safe()`](https://sims1253.github.io/huerd/branch/deprecate/nlopt-direct/reference/is_cvd_safe.md)
