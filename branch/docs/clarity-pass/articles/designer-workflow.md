...
huerd preserves the brand colors exactly and generates optimized
complementary colors.

## Visualizing Your Palette

See your full palette in one view:
...
For print materials, avoid very light or very dark colors:
...
Show stakeholders how the palette appears to viewers with color vision
deficiency:
...
1.  **[`brand_palette()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/brand_palette.md)** -
    Start with your required brand colors
2.  **`quick_palette(lightness = ...)`** - Control lightness for
    print/digital
3.  **[`interpret_palette_quality()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/interpret_palette_quality.md)** -
    Client-ready quality language
4.  **[`simulate_palette_cvd()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/simulate_palette_cvd.md)** -
    Accessibility documentation
5.  **[`export_palette()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/export_palette.md)** -
    CSS, Sass, JSON, CSV exports
6.  **[`reproduce_palette()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/reproduce_palette.md)** -
