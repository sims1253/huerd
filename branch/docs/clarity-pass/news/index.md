...
- [`is_cvd_safe()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/is_cvd_safe.md)’s
...
- Documentation copy-edited throughout for clarity (Orwell/STE pass:
  active voice, shorter sentences, consistent terminology, “OK LAB”
  unified to “OKLAB”) across the README, all four vignettes, the
  DESCRIPTION, and the roxygen reference docs; no code, API, or
...
- [`interpret_palette_quality()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/interpret_palette_quality.md)
...
- `validate_color_input_smart()` now reports the actual problem (“Colors
  ...
  message
- [`export_palette()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/export_palette.md)
...
- The previously ignored `cvd_safe` arguments of
  ...
  and
  [`brand_palette()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/brand_palette.md)
  are now forwarded to
  [`generate_palette()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/generate_palette.md)
  and take effect
- [`reproduce_palette()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/reproduce_palette.md)
...
- Added
  [`plot.huerd_palette()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/plot.huerd_palette.md)
  method with “swatches” and “analysis” plot types
- Added ggplot2 integration:
  [`scale_color_huerd()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/scale_color_huerd.md),
  [`scale_fill_huerd()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/scale_color_huerd.md),
  [`scale_colour_huerd()`](https://sims1253.github.io/huerd/branch/docs/clarity-pass/reference/scale_color_huerd.md)
