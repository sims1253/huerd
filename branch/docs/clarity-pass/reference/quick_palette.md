...
with intuitive parameter names and sensible defaults. Use it when you
want good results without understanding optimization details.
...
- brand_colors:
  ...
  palette. The optimizer preserves these colors exactly as provided and
  optimizes the additional colors around them.
