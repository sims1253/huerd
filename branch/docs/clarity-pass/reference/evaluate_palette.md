...
distinguishability, CVD safety, and color distribution. Returns raw
metrics without subjective scoring for post-hoc analysis.
...
- colors:
  ...
  A character vector of hex colors, or a matrix of colors in OKLAB
  space.
...
metrics (distances, CVD safety, distribution) for analysis without
subjective heuristic scoring.
