...
2.  **Pairwise Distance Matrix**: A heatmap showing the perceptual
    distance between every pair of colors.
3.  **Nearest Neighbor Distances**: A bar chart showing how distinct
    each color is from its closest neighbor.
4.  **OKLAB Color Space**: A projection of the colors in the `a*b*`
    plane of the OKLAB space.
5.  **CVD Simulation**: How the palette appears to individuals with the
    three most common types of color vision deficiency.
6.  **Comparative Palettes**: A comparison of your palette’s distance
    distribution against established palettes like Viridis and Set2.
