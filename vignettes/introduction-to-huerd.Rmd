...
2.  **OKLAB Color Space**: A projection of the colors in the `a*b*` plane of the OKLAB space, with point size indicating lightness.
3.  **Pairwise Distance Matrix**: A heatmap showing the perceptual distance between every pair of colors on a fixed scale, so cell colors are comparable across palettes.
4.  **CVD Simulation**: How the palette appears to individuals with the three most common types of color vision deficiency, plus greyscale.
