describe("evaluate_palette()", {
  ...
  it("handles empty color vector after NA filtering", {
    ...
    # Literal "NA" string should be rejected as invalid hex color
    literal_na_colors <- c("NA")
    expect_error(
      evaluate_palette(literal_na_colors),
      "If 'colors' is character, all elements must be valid hex codes or NA."
    )
  })

  it("handles invalid matrix dimensions", {
  ...
  it("handles empty matrix edge cases", {
...
describe("evaluate_palette_quality()", {
  it("works with single color", {
  ...
  it("handles hex colors input directly (bug fix)", {
  ...
  it("handles edge cases without crashes", {
  ...
  it("input validation works correctly", {
...
describe("analyze_cvd_safety_metrics()", {
  ...
  it("calculates preserved ratios", {
  ...
  it("includes hue order preservation check", {
  ...
  it("detects hue order preservation correctly", {
...
describe("analyze_color_distribution()", {
  it("returns proper structure", {
