...
test_that("generate_palette accepts weights parameter", {
  ...
  palette_distance <- generate_palette(n = 3, weights = c(distance = 1), progress = FALSE)
  ...
  palette_distance_2 <- generate_palette(n = 3, weights = c(distance = 2.5), progress = FALSE)
...
test_that("generate_palette backward compatibility with weights", {
  ...
  set.seed(123)
  palette_new <- generate_palette(n = 3, weights = c(distance = 1), progress = FALSE)
...
test_that("generate_palette accepts optimizer parameter", {
  ...
  palette_nloptr <- generate_palette(n = 3, optimizer = "nloptr_cobyla", progress = FALSE)
...
test_that("generate_palette optimizer parameter is backward compatible", {
  ...
  set.seed(789)
  palette_explicit <- generate_palette(n = 3, optimizer = "nloptr_cobyla", progress = FALSE)
...
test_that("generate_palette accepts nlopt_direct optimizer", {
  ...
  palette_direct <- generate_palette(n = 3, optimizer = "nlopt_direct", progress = FALSE)
...
test_that("generate_palette nlopt_direct optimizer has proper attributes", {
  ...
  palette <- generate_palette(n = 3, optimizer = "nlopt_direct", progress = FALSE)
...
test_that("generate_palette nlopt_direct optimizer returns colors sorted by brightness", {
  ...
  palette <- generate_palette(n = 5, optimizer = "nlopt_direct", progress = FALSE)
...
test_that("generate_palette nlopt_direct optimizer is deterministic", {
  ...
  palette1 <- generate_palette(n = 3, optimizer = "nlopt_direct", progress = FALSE)
  palette2 <- generate_palette(n = 3, optimizer = "nlopt_direct", progress = FALSE)
  ...
  palette3 <- generate_palette(n = 3, optimizer = "nlopt_direct", progress = FALSE)
  palette4 <- generate_palette(n = 3, optimizer = "nlopt_direct", progress = FALSE)
...
test_that("generate_palette accepts nlopt_neldermead optimizer", {
  ...
  palette_neldermead <- generate_palette(n = 3, optimizer = "nlopt_neldermead", progress = FALSE)
...
test_that("generate_palette nlopt_neldermead optimizer has proper attributes", {
  ...
  palette <- generate_palette(n = 3, optimizer = "nlopt_neldermead", progress = FALSE)
...
test_that("generate_palette nlopt_neldermead optimizer returns colors sorted by brightness", {
  ...
  palette <- generate_palette(n = 5, optimizer = "nlopt_neldermead", progress = FALSE)
...
test_that("generate_palette nlopt_neldermead optimizer produces reasonable consistency", {
  ...
  palette1 <- generate_palette(n = 3, optimizer = "nlopt_neldermead", progress = FALSE)
  palette2 <- generate_palette(n = 3, optimizer = "nlopt_neldermead", progress = FALSE)
